...
set_var PROXY_LOG_IP 0
set_var CLARO_API_429_RETRIES "${CLARO_API_429_RETRIES:-4}"
set_var CLARO_LINK_TIMEOUT_MS "${CLARO_LINK_TIMEOUT_MS:-12000}"
set_var CLARO_LINK_429_RETRIES "${CLARO_LINK_429_RETRIES:-5}"
set_var CLARO_LINK_429_BACKOFF_MS "${CLARO_LINK_429_BACKOFF_MS:-800}"
