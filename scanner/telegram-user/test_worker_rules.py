...
from worker_rules import claim_allowed, decide_next_action, is_claro_payload, payload_operator
...
def test_payload_claro():
    assert is_claro_payload("85992927164|CLARO|20") is True
    assert is_claro_payload("96991174646|VIVO|30") is False
    assert payload_operator("96991174646|VIVO|30") == "VIVO"
